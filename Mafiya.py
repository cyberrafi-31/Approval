...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=61551411116495')
time.sleep(5)
...
\__|     \__|\__|  \__|      \__|  \__|\__|  \__|\__|      \______|
     ...
     ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;27m==================================================
[] AUTHOR       :       𝑴𝒓 𝑹𝒂𝒇𝒊 𝑪𝒉𝒐𝒘𝒅𝒉𝒖𝒓𝒚
[] TOOLS        :       𝑭 𝑰 𝑳 𝑬   𝑪 𝑳 𝑶 𝑵 𝑬
[] TYPE         :      𝑭𝒓𝒆𝒆 𝑨𝒑𝒑𝒓𝒐𝒗𝒂𝒍
[] FACEBOOK     :      𝕽𝖆𝖋𝖎 𝕮𝖍𝖔𝖜𝖉𝖍𝖚𝖗𝖞
[] VERSION.     :     8.7
=================================================="\033[1;27m"""
os.system('clear')
print(logo)
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/cyberrafi-31/Approval/blob/main/Approval.txt').text
    if id in httpCaht:
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+8801877721475?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(f'https://github.com/cyberrafi-31/Approval/blob/main/Approval.txt').text
    try:
        httpCaht = requests.get(f"https://github.com/cyberrafi-31/Approval/blob/main/Approval.txt").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
